...
# types of variables ac_pysmac supports. Here these definitions are overly
...
value, parameters = opt.minimize(
    ...
    int(1000),  # the number of function calls allowed
    parameter_dict=parameters)  # the parameter dictionary
