...
# way ac_pysmac implements parallelism, the data is either a global variable, or
...
value, parameters = opt.minimize(random_forest,
                                 ...
                                 # in a real setting, you probably want to do more than 100 evaluations here
                                 ...
                                 # There are a build-in mechanisms to limit the resources available to each function call:
                                 t_limit_function_s=20
                                 # You can limit the memory available and the wallclock time for each function call
                                 )
